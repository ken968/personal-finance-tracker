            ...
            <div class="lg:col-span-4 xl:col-span-3">
                <div class="bg-white dark:bg-[#1c2e36] rounded-3xl p-6 shadow-xl border border-gray-100 dark:border-white/5 sticky top-24">
                  ...
                  <div class="mb-6">
                    ...
                    <div class="grid grid-cols-2 gap-1 p-1 bg-gray-200 dark:bg-[#132329] rounded-xl">
                      <label class="cursor-pointer">
                        <input class="peer sr-only" name="cat_type" type="radio" value="income" />
                        <div class="flex items-center justify-center h-10 rounded-lg text-sm font-medium text-gray-500 dark:text-[#92c9b7] peer-checked:bg-white dark:peer-checked:bg-[#1c2e36] peer-checked:text-emerald-600 dark:peer-checked:text-emerald-400 peer-checked:shadow-sm transition-all select-none border border-transparent peer-checked:border-gray-200 dark:peer-checked:border-white/5">
                          Income
                        </div>
                      </label>
                      <label class="cursor-pointer">
                        <input checked class="peer sr-only" name="cat_type" type="radio" value="expense" />
                        <div class="flex items-center justify-center h-10 rounded-lg text-sm font-medium text-gray-500 dark:text-[#92c9b7] peer-checked:bg-white dark:peer-checked:bg-[#1c2e36] peer-checked:text-rose-600 dark:peer-checked:text-rose-400 peer-checked:shadow-sm transition-all select-none border border-transparent peer-checked:border-gray-200 dark:peer-checked:border-white/5">
                          Expense
                        </div>
                      </label>
                    </div>
